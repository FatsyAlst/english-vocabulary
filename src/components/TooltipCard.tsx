      ...
      <AnimatePresence>
        {isVisible && (
          <motion.div
            ...
            className="pointer-events-none absolute z-50 min-w-[15rem] overflow-hidden rounded-md border border-zinc-700 bg-zinc-900 shadow-lg shadow-black/20 ring-1 ring-white/5"
            style={{
              top: position.y,
              left: position.x,
            }}
          >
            <div
              ref={contentRef}
              className="p-2 text-sm text-zinc-400 md:p-4"
            >
              {content}
            </div>
          </motion.div>
